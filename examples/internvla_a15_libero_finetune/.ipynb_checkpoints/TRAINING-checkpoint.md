...
| `save_freq` | 5,000（= steps/6） | 5〜6 個残る |
| `batch_size` | **probe で確定** | |
...
IVLA_BS=<probe で OK だった最大値> bash scripts/tmux_train.sh
```
